...
GRADE_MATRIX сверен с активной структурой листа Jobgrades в
«Калькулятор Hay Group.xlsm»: диапазон Jobgrades!$I$6:$L$44 (именованный
``vllRange``), где I/J/K/L = lower/mid/upper/grade. Какая из трёх колонок-
кандидатов (B «Standard Hay Buckets», C «15% Steps», D «Client Specific»)
активна, решает Jobgrades!M3=CHOOSE(...); в книге M3=1, поэтому действует
колонка B. Граница grade=38: Jobgrades!I44:K44 = 15081/16310/17540, за ней
Jobgrades!I45="XX" (нет грейда выше 38) — расширенные 39 полос в NEW верны,
32 полосы в ветке backup-old-tables — обрезанная версия той же таблицы.
"""
